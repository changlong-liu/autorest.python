...
class VisibilityClientOperationsMixin(VisibilityClientMixinABC):
    @overload
    def get_model(
        self, input: Union[_models.VisibilityModel, JSON], *, content_type: str = "application/json", **kwargs: Any
    ) -> _models.VisibilityModel:
        """get_model.

        :param input: Required.
        :type input: ~models.visibility.models.VisibilityModel or JSON
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: VisibilityModel. The VisibilityModel is compatible with MutableMapping
        :rtype: ~models.visibility.models.VisibilityModel
    ...
    def get_model(self, input: Union[_models.VisibilityModel, JSON, IO], **kwargs: Any) -> _models.VisibilityModel:
        ...
        :type input: ~models.visibility.models.VisibilityModel or JSON or IO
