...
from ._configuration import PlayFabClientConfiguration
from ._operations import PlayFabClientOperationsMixin


class PlayFabClient(PlayFabClientOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :param endpoint: The endpoint of your PlayFab service. Required.
    :type endpoint: str
    """
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = PlayFabClientConfiguration(endpoint=endpoint, **kwargs)
    ...
    async def __aenter__(self) -> "PlayFabClient":
